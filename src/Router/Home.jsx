    ...
    return (
        <>
            ...
            <div className=' max-w-[99%] lg:max-w-[90%] md:mx-auto px-4 flex flex-col-reverse md:flex-row my-8 items-center justify-center'>
                ...
                <div className='md:w-1/2 w-full'><img
                    src={pic}
                    alt="Food Donation"
                ...
                <div className='md:mt-10 md:w-1/2'>
                    <h1 className='text-3xl pb-4 text-[#22A699]'>About</h1>
        ...
        <div className='text-center'>
            <h1 className='text-[#F24C3D] text-3xl sm:text-4xl px-3 py-2'>Extending a Hand <span className='text-[#F24C3D] '> Our Guiding Mission </span></h1>
